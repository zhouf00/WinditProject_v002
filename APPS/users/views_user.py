...
from users.forms import LoginForm, UserCreateForm, UserUpdataForm, AdminPasswdChangeForm
...
class UserView(LoginRequiredMixin, View):
    ...
    def get(self, request):
        ret = SystemSetup.getSystemSetupLastData()
        return render(request, 'system/users/user_list.html', ret)
...
class UserUpdateView(LoginRequiredMixin, View):
    ...
    def post(self, request):
        ...
        if user_updata_form.is_valid():
            ...
            ret = {'status': 'fail',
                   'message': user_updata_form.errors}
        return HttpResponse(json.dumps(ret), content_type='application/json')
...
class AdminPasswdChangeView(LoginRequiredMixin, View):
    ...
    def get(self, request):
        ...
        if 'id' in request.GET and request.GET['id']:
            ...
            ret['user'] = user
        return render(request, 'system/users/admin_passwdChange.html')
